...
$sql = "SELECT id_tabla, id_liga, id_torneo, id_equipo, jj, jg, je, jp, gf, gc, dif, pts FROM tablas WHERE id_liga='$numerodeliga' ORDER BY pts DESC";
...
echo "        <div class=\"col-sm-4\" align=\"center\"></div>\n"; 
echo "        <div class=\"col-sm-4\" align=\"center\"></div>\n"; 
echo "    </div>\n";
echo "\n";
